...
import { signInFarmer } from "../../../api-clients";
...
function FarmerSignIn() {
  ...
  const mutation = useMutation(signInFarmer, {
    onSuccess: async () => {
      showToast({
        message: "Farmer Sign-In Successful",
        type: "SUCCESS",
      });
      ...
      <div className="flex bg-white shadow-lg rounded-lg overflow-hidden max-w-4xl w-full">
        ...
        <div className="flex-1 p-8">
          <form className="space-y-6" onSubmit={onSubmit}>
            <h2 className="text-3xl font-bold text-gray-800">Farmer Sign In</h2>
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-slate-600">
                Not Registered?{" "}
                <Link className="underline text-teal-600" to="/farmer-register">
